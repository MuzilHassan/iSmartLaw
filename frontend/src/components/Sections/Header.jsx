          ...
          <QuoteWrapper className="flexCenter darkBg radius8">
            ...
            <div>
              <p className="font15 whiteColor">
                <em>The dead cannot cry out for justice. It is a duty of the living to do so for them." </em>
              </p>
              <p className="font13 orangeColor textRight" style={{marginTop: '10px'}}>- Lois McMaster Bujold</p>
            </div>
          </QuoteWrapper>
          <DotsWrapper>
            <Dots />
